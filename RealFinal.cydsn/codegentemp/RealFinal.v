// ======================================================================
// RealFinal.v generated from TopDesign.cysch
// 12/02/2016 at 01:36
...
module BLE_v3_10_3 (
	...
	cy_clock_v1_0
		#(.id("22db502a-628e-4c75-803e-bfc48fb60018/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("025f799f-cca1-48e2-a2b4-833c4f9dbca1"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f86b01db-cdde-4bfc-b641-2e25751c3ebc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Servo_En_1_net;
	wire [0:0] tmpFB_0__Servo_En_1_net;
	wire [0:0] tmpIO_0__Servo_En_1_net;
	wire [0:0] tmpINTERRUPT_0__Servo_En_1_net;
	electrical [0:0] tmpSIOVREF__Servo_En_1_net;

	cy_psoc3_pins_v1_10
		#(.id("f920eabb-33dd-46f7-9a14-17f7ad22aead"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Servo_En_1
		 (.oe(tmpOE__Servo_En_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Servo_En_1_net[0:0]}),
		  .io({tmpIO_0__Servo_En_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Servo_En_1_net),
		  .interrupt({tmpINTERRUPT_0__Servo_En_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Servo_En_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Servo_En_2_net;
	wire [0:0] tmpFB_0__Servo_En_2_net;
	wire [0:0] tmpIO_0__Servo_En_2_net;
	wire [0:0] tmpINTERRUPT_0__Servo_En_2_net;
	electrical [0:0] tmpSIOVREF__Servo_En_2_net;

	cy_psoc3_pins_v1_10
		#(.id("4f783be7-b00f-4875-9e05-5bc1d8326dc7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Servo_En_2
		 (.oe(tmpOE__Servo_En_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Servo_En_2_net[0:0]}),
		  .io({tmpIO_0__Servo_En_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Servo_En_2_net),
		  .interrupt({tmpINTERRUPT_0__Servo_En_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Servo_En_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("99110f1c-43bc-43b9-9bd6-ca3d14a7733f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ee40866a-e99e-4eb9-af44-48d1db54c33e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c31b4475-4b20-4062-bbbe-8350780fb26e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_70_1 Countdown (
        ...
        .tc(Net_844),
        .clock(Net_10));
    defparam Countdown.CaptureCount = 2;
    defparam Countdown.CaptureCounterEnabled = 0;
    defparam Countdown.DeviceFamily = "PSoC4";
    defparam Countdown.InterruptOnCapture = 0;
    defparam Countdown.InterruptOnTC = 0;
    defparam Countdown.Resolution = 16;
    defparam Countdown.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Key_Switch_net;
	wire [0:0] tmpFB_0__Key_Switch_net;
	wire [0:0] tmpIO_0__Key_Switch_net;
	wire [0:0] tmpINTERRUPT_0__Key_Switch_net;
	electrical [0:0] tmpSIOVREF__Key_Switch_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Key_Switch
		 (.oe(tmpOE__Key_Switch_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Key_Switch_net[0:0]}),
		  .io({tmpIO_0__Key_Switch_net[0:0]}),
		  .siovref(tmpSIOVREF__Key_Switch_net),
		  .interrupt({tmpINTERRUPT_0__Key_Switch_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Key_Switch_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Servo_En_3_net;
	wire [0:0] tmpFB_0__Servo_En_3_net;
	wire [0:0] tmpIO_0__Servo_En_3_net;
	wire [0:0] tmpINTERRUPT_0__Servo_En_3_net;
	electrical [0:0] tmpSIOVREF__Servo_En_3_net;

	cy_psoc3_pins_v1_10
		#(.id("dbd078f3-2365-41d1-800f-892f0783a200"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Servo_En_3
		 (.oe(tmpOE__Servo_En_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Servo_En_3_net[0:0]}),
		  .io({tmpIO_0__Servo_En_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Servo_En_3_net),
		  .interrupt({tmpINTERRUPT_0__Servo_En_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Servo_En_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1c4b70e4-dae8-48ec-9a25-d1bf44bd56f9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("daec548a-e922-4f43-8d62-106ff431a784"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
